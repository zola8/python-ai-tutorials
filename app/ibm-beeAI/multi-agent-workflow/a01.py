...
# https://github.com/IBM/ibmdotcom-tutorials/tree/main/generative-ai/bee-ai-multi-agent-contract-management
...
async def main() -> None:
    ...
    # contractor_company = input("Please enter the contractor company: ")
    contractor_company = "Company B"

    # client_budget_file = input(
    #     f"Enter the file name of the budget report for {client_company} (in the same directory level): ")  # Example: budget_data.csv
    ...
    # contract_file = input(
    #     f"Enter the file name of the contract between {client_company} and {contractor_company} (in the same directory level): ")  # Example: contract.txt
    ...
    # service_industry = input(
    #     f"Enter the industry of the service described in this contract (e.g., finance, construction, etc.): ")  # Example: landscaping
    service_industry = "landscaping"

    print("*** Workflow Procurement ***")
    print("client_company:", client_company)
    print("contractor_company:", contractor_company)
    print("client_budget_file:", client_budget_file)
    print("contract_file:", contract_file)
    print("service_industry:", service_industry)
