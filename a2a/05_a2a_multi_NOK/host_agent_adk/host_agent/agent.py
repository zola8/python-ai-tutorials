...
# agent_card: additional_interfaces=None capabilities=AgentCapabilities(extensions=None, push_notifications=None, state_transition_history=None, streaming=True) default_input_modes=['text/plain'] default_output_modes=['text/plain'] description="An agent that manages Karley's schedule for pickleball games." documentation_url=None icon_url=None name='Karley Agent' preferred_transport='JSONRPC' protocol_version='0.3.0' provider=None security=None security_schemes=None signatures=None skills=[AgentSkill(description="Checks Karley's availability for a pickleball game on a given date.", examples=['Is Karley free to play pickleball tomorrow?'], id='check_schedule', input_modes=None, name="Check Karley's Schedule", output_modes=None, security=None, tags=['scheduling', 'calendar'])] supports_authenticated_extended_card=None url='http://localhost:10002/' version='1.0.0'
# agent_url: http://localhost:10002
# agent_card: additional_interfaces=None capabilities=AgentCapabilities(extensions=None, push_notifications=None, state_transition_history=None, streaming=False) default_input_modes=['text/plain'] default_output_modes=['text/plain'] description='A friendly agent to help you schedule a pickleball game with Nate.' documentation_url=None icon_url=None name='Nate Agent' preferred_transport='JSONRPC' protocol_version='0.3.0' provider=None security=None security_schemes=None signatures=None skills=[AgentSkill(description="Check my calendar to see when I'm available for a pickleball game.", examples=['Are you free tomorrow?', 'Can you play pickleball next Tuesday at 5pm?'], id='availability_checker', input_modes=None, name='Availability Checker', output_modes=None, security=None, tags=['schedule', 'availability', 'calendar'])] supports_authenticated_extended_card=None url='http://localhost:10003/' version='1.0.0'
# agent_url: http://localhost:10003
# agent_card: additional_interfaces=None capabilities=AgentCapabilities(extensions=None, push_notifications=True, state_transition_history=None, streaming=True) default_input_modes=['text', 'text/plain'] default_output_modes=['text', 'text/plain'] description='Helps with scheduling pickleball games' documentation_url=None icon_url=None name='Kaitlynn Agent' preferred_transport='JSONRPC' protocol_version='0.3.0' provider=None security=None security_schemes=None signatures=None skills=[AgentSkill(description="Helps with finding Kaitlyn's availability for pickleball", examples=['Are you free to play pickleball on Saturday?'], id='schedule_pickleball', input_modes=None, name='Pickleball Scheduling Tool', output_modes=None, security=None, tags=['scheduling', 'pickleball'])] supports_authenticated_extended_card=None url='http://localhost:10004/' version='1.0.0'
# agent_url: http://localhost:10004
# agent_info:
# [
#    "{\"name\": \"Karley Agent\", \"description\": \"An agent that manages Karley\\'s schedule for pickleball games.\"}",
#    "{\"name\": \"Nate Agent\", \"description\": \"A friendly agent to help you schedule a pickleball game with Nate.\"}",
#    "{\"name\": \"Kaitlynn Agent\", \"description\": \"Helps with scheduling pickleball games\"}"
# ]
# HostAgent initialized
